package com.se3.elearning.firebase;
...
import com.se3.elearning.student.social.IncomingInvitationActivity;
...
public class MessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        user.userName = remoteMessage.getData().get(Constants.KEY_USER_NAME);
        user.userToken = remoteMessage.getData().get(Constants.KEY_FCM_TOKEN);

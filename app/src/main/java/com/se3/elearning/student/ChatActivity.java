...
import com.se3.elearning.databinding.ActivityChatBinding;
...
public class ChatActivity extends BaseActivity {
    ...
    private  void sendMessage(){
        ...
        if (conversionId != null){
            ...
            conversion.put(Constants.KEY_SENDER_IMAGE, preferenceManager.getString(Constants.KEY_USER_NAME).substring(0,1));
            conversion.put(Constants.KEY_RECEIVER_ID, receiverUser.id);
            conversion.put(Constants.KEY_RECEIVER_NAME, receiverUser.userName);
            conversion.put(Constants.KEY_RECEIVER_IMAGE, receiverUser.userName.substring(0,1));
        ...
        if (!isReceiverAvailable){
            try {
                ...
                tokens.put(receiverUser.userToken);
    ...
    private void listenAvailabilityOfRevceiver(){
        database.collection(Constants.KEY_COLLECTION_USERS).document(
            ...
            if(value != null){
                ...
                receiverUser.userToken = value.getString(Constants.KEY_FCM_TOKEN);
            }
            if(isReceiverAvailable){
        ...
        if(value != null){
            ...
            for (DocumentChange documentChange : value.getDocumentChanges()){
                if (documentChange.getType() == DocumentChange.Type.ADDED){
                    ...
                    chatMessage.msg = documentChange.getDocument().getString(Constants.KEY_MESSAGE);

...
public class IncomingInvitationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String firstName = getIntent().getStringExtra(Constants.KEY_USER_NAME);

        if (firstName != null){
            textFirstChar.setText(firstName.substring(0 , 1));
        }

        textUsername.setText(String.format("%s", firstName));
        ...
        ImageView imageRejectionInvitation = findViewById(R.id.imageRejectInvitation);
        imageRejectionInvitation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                sendInvitationResponse(
